...
function Certificate({ sendOpenImg, sendImg, sendTxt }) {
  ...
  useEffect(() => {
    if (selectlatestRelevance === "latest") {
      if (selectcertificate === "certificateToo")
        setCertificate(sortCertificateToo);
      else if (selectcertificate === "certificateCloud")
        setCertificate(sortCertificateCloud);
      else if (selectcertificate === "certificateOthers")
        setCertificate(sortCertificateOthers);
      else if (selectcertificate === "certificateSkills")
        setCertificate(sortCertificateSkills);
      else if (selectcertificate === "certificateLanguages")
        setCertificate(sortCertificateLanguages);
      else if (selectcertificate === "certificateIotAi")
        setCertificate(sortCertificateIotAi);
      else if (selectcertificate === "All") setCertificate(dataAllTotalSort);
    } else if (selectlatestRelevance === "relevance") {
      if (selectcertificate === "certificateToo")
        setCertificate(certificateToo);
      else if (selectcertificate === "certificateCloud")
        setCertificate(certificateCloud);
      else if (selectcertificate === "certificateOthers")
        setCertificate(certificateOthers);
      else if (selectcertificate === "certificateSkills")
        setCertificate(certificateSkills);
      else if (selectcertificate === "certificateLanguages")
        setCertificate(certificateLanguages);
      else if (selectcertificate === "certificateIotAi")
        setCertificate(certificateIotAi);
      else if (selectcertificate === "All") setCertificate(dataAllTotal);
    }
